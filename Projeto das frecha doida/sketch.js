...
function blueBalloon() {
  var blue = createSprite(0,Math.round(random(20, 370)),0, 10, 10);
...
function greenBalloon() {
  var green = createSprite(0,Math.round(random(20, 370)),0, 10, 10);
...
function pinkBalloon() {
  var pink = createSprite(0,Math.round(random(20, 370)),0, 10, 10);
